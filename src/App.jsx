...
import illustrationThankYTou from "./assets/illustration-thank-you.svg"
  ...
  return (
    submited === false ? (
      ...
      <div className="bg-dark-blue w-fit p-4 rounded-full mb-4">
        ...
        <button className="bg-orange w-full uppercase tracking-1 font-bold rounded-3xl text-sm py-3 hover:text-orange hover:bg-white cursor-pointer" onClick={handleSubmit}>Submit</button>
      
      </div>
    ) : (
      <div className="bg-gradient-dark text-white mx-6 p-6 rounded-2xl font-overpass max-w-103">
        <img className="mx-auto mb-6" src={illustrationThankYTou} alt="illustration thank you" />

        <p className="text-orange bg-dark-blue mx-auto w-fit px-3 py-1.25 rounded-3xl  mb-6">You selected {notaAvaliacao} out of 5</p>

        <h1 className="text-2xl font-bold mb-2.5 text-center">Thank You!</h1>

        <p className="text-sm text-light-grey mb-6 leading-1 text-center">We appreciate you taking the time to give a rating. If you ever need more support, don’t hesitate to get in touch!</p>
      </div>
    )
  )
}